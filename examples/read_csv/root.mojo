...
fn init() raises -> None:
    ...
    root_command.add_flag(Flag(name="file", shorthand="f", usage="CSV file to read."))
    root_command.add_flag(Flag(name="lines", shorthand="l", usage="Lines to print.", default="3"))
