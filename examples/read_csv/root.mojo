# from prism import FlagSet, Command, no_args
# from external.goodies import CSVReader, FileWrapper
# from os.path import exists


# fn handler(flags: FlagSet, args: List[String]) -> Error:
#     var file_path = flags.get_as_string("file").value()[]
...
#         var lines = flags.get_as_int("lines").value()[]
