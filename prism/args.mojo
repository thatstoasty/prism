...
# fn no_args(command: Arc[Command], args: List[String]) -> Optional[String]:
...
# fn arbitrary_args(command: Arc[Command], args: List[String]) -> Optional[String]:
...
#     fn less_than_n_args(command: Arc[Command], args: List[String]) -> Optional[String]:
#         var cmd = command
#         if len(args) < n:
#             return sprintf(
...
#     fn more_than_n_args(command: Arc[Command], args: List[String]) -> Optional[String]:
#         var cmd = command
#         if len(args) > n:
...
#     fn exactly_n_args(command: Arc[Command], args: List[String]) -> Optional[String]:
#         var cmd = command
#         if len(args) != n:
...
#     fn only_valid_args(command: Arc[Command], args: List[String]) -> Optional[String]:
#         var cmd = command
#         if len(valid) > 0:
#             for arg in args:
...
#     fn range_n_args(command: Arc[Command], args: List[String]) -> Optional[String]:
#         var cmd = command
...
#     fn match_all_args(command: Arc[Command], args: List[String]) -> Optional[String]:
